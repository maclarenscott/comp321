...
If multiple words share the same score, \textbf{any} word with the appropriate score is acceptable.
...
\emph{$k$-th least evil} and \emph{$k$-th most evil} words among all words seen so far:
\begin{itemize}
